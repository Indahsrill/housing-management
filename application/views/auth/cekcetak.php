                                    ...
                                    <form action="<?= base_url() ?>auth/html" method="post">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <button type="button" class="btn btn-info" onclick="cekPembayaran()">Cek
                                                    Pembayaran</button>
                                                <!-- <div class="input-group-text">
                            </div> -->
                                            </div>
                                        </div>
                                        <div id="cekPembayaran">
                                        ...
                                        <div class=" mt-3">
                                            ...
                                            <button type="submit" class="btn mr-2 ml-2 btn-lg btn-success"
                                                ...
                                                Bukti
                                                Pembayaran</button>
                                            <a href="<?= base_url() ?>" class="btn mr-2 ml-2 btn-lg btn-primary"
                                                style="float:left">Kembali Login</a>
